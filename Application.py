...
"")
        ...
        self.image1_component1_slider.sliderMoved['int'].connect(self.image1_component1_LCD.display) # type: ignore
        self.image2_component1_slider.sliderMoved['int'].connect(self.image2_component1_LCD.display) # type: ignore
        self.RegionSlider.sliderMoved['int'].connect(self.region_LCD.display) # type: ignore
        self.image4_component1_slider.sliderMoved['int'].connect(self.image4_component1_LCD.display) # type: ignore
        self.image3_component1_slider.sliderMoved['int'].connect(self.image3_component1_LCD.display) # type: ignore
